...
const EventOrganizer = () => {
  ...
  return (
    <>
      ...
      >
        <div className='bg-cardbg bg-opacity-25 min-w-[300px] p-5 rounded-[10px] lg:min-h-[640px] p-[20px]'>
          <motion.h4
          ...
          <div className='flex flex-col lg:flex-col text-left gap-0 lg:gap-5'>
