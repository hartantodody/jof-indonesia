...
const AboutUs = () => {
  ...
  return (
    <>
      <section ref={ref} className='flex flex-row sm:flex-row justify-center items-center mx-auto p-[109px]'>
        <motion.img
          ref={ref}
          initial='hidden'
          ...
          className='flex flex-wrap flex-row justify-center items-center mb-[41px] max-w-[100%]'
          src={illustration}
        ...
        <motion.article
          ...
          animate={inView ? "visible" : "hidden"}
          variants={variants2}
          className='flex flex-wrap flex-col justify-center items-start p-10'
        >
          <motion.h4
            ref={ref}
            initial='hidden'
          ...
          >
            Making every project, a passion. Project makes us more emphatic to your event and making sure that
            everything is delivered to the maximum satisfactory of our client.
          </motion.p>
          <motion.button
            ref={ref}
            initial='hidden'
