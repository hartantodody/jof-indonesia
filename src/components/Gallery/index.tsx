...
const Gallery = () => {
  ...
  return (
    <div className='relative flex justify-center'>
      <div className='max-w-[800px] h-[300px] lg:h-[500px] relative'>
        <img
        ...
        <div className='absolute bottom-0 left-0 w-full h-70 p-6 lg:p-10 text-white bg-black bg-opacity-50'>
          <h2
            className={`transition-opacity duration-500 ease-in-out ${
              isTransitioning ? "opacity-0" : "opacity-100"
            } text-[14px] lg:text-3xl font-bold`}
          >
